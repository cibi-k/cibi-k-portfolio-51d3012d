...
const profiles = [
  ...
  { name: "Codeforces", url: "https://codeforces.com/profile/", icon: Swords, gradient: "from-[hsl(210,80%,50%)] to-[hsl(230,70%,55%)]", description: "Competitive programming", stats: "Newbie" },
];
