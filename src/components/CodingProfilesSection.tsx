...
const profiles = [
  ...
  { name: "Codeforces", url: "https://codeforces.com/profile/", icon: Code, gradient: "from-[hsl(220,90%,56%)] to-[hsl(350,80%,55%)]", description: "Competitive programming", stats: "Active" },
];
