...
const achievements = [
  ...
  { title: "Python for Data Science", org: "IBM / Coursera", icon: Trophy, description: "Professional certificate in Python programming, data analysis, and visualization using pandas and matplotlib." },
];
    ...
    <div className="grid md:grid-cols-3 gap-6">
      {achievements.map((a, i) => (
        <motion.div
          ...
          whileHover={{ y: -5 }}
          className="bg-card rounded-xl border border-border p-6 glow-card text-center"
        >
