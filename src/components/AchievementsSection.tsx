...
const achievements = [
  {
    ...
    org: "Google / Coursera",
    icon: Award,
    description: "Completed comprehensive AI fundamentals course covering machine learning, neural networks, and practical applications.",
  },
  {
    title: "Deep Learning Specialization",
    org: "Coursera",
    icon: BookOpen,
    description: "Five-course specialization covering CNNs, RNNs, sequence models, and structuring ML projects.",
  },
  {
    title: "Python for Data Science",
    org: "IBM / Coursera",
    icon: Trophy,
    description: "Professional certificate in Python programming, data analysis, and visualization using pandas and matplotlib.",
  },
];
